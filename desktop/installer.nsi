...
!define APP_NAME "嘴臭模擬器"
!define APP_NAME_SHORT "InsultSimulator"
!define APP_VERSION "1.0.0"
!define APP_EXE "InsultSimulator.exe"
!define APP_PUBLISHER "InsultSimulator"

Name "${APP_NAME}"
OutFile "dist\InsultSimulator-Setup.exe"
...
Function .onInit
  nsExec::ExecToLog 'taskkill /IM ${APP_EXE} /F /T'
FunctionEnd
